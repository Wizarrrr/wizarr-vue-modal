export default {
  ...
  sitemap: {
    hostname: "https://modal.wizarr.dev",
  },
  themeConfig: {
    nav: nav(),
    sidebar: sidebar(),
    ...
    socialLinks: [
      { icon: "github", link: "https://github.com/wizarrrr/wizarr-vue-modal" },
    ],
    footer: {
      message: "Released under the MIT License.",
      copyright: "Copyright © 2022-present Wizarr",
    },
  },
  locales: {
    root: {
  ...
  return [
    {
      ...
      activeMatch: getLink("/guide/"),
    },
    {
      text: getLabel("examples"),
      link: getLink("/examples/list"),
      activeMatch: getLink("/examples/"),
    },
    {
      text: getLabel("found mistake?"),
      link: "https://github.com/wizarrrr/wizarr-vue-modal/issues/new?assignees=&labels=bug&projects=&template=bug_report.md&title=[BUG]",
    },
  ];
}
  ...
  return [
    {
      ...
      items: [
        {
          text: getLabel("get started!"),
          link: getLink("/guide/getting-started"),
        },
        { text: getLabel("methods"), link: getLink("/guide/guide-methods") },
        {
          text: getLabel("navigation guards"),
          link: getLink("/guide/guide-navigation-guards"),
        },
        {
          text: getLabel("returned value"),
          link: getLink("/guide/guide-returned-value"),
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: getLabel("animation"),
          link: getLink("/guide/details-animation"),
        },
      ],
    },
    {
      ...
      items: [
        {
          text: getLabel("introduction"),
          link: getLink("/guide/integration-introduction"),
        },
        {
          text: getLabel("installation"),
          link: getLink("/guide/integration-installation"),
        },
        {
          text: getLabel("practical"),
          link: getLink("/guide/integration-practical"),
        },
        {
          text: getLabel("closing Modal with Router"),
          link: getLink("/vue-router-integration/close-after-route-changed"),
        },
      ],
    },
  ];
